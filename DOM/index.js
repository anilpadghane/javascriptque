...
document.getElementById("text").innerText = "Hello this is new text!!";


//Que-2 Write the code to access element which is having tag as "h1"

document.getElementsByTagName("h1")[0].innerText =
  "The code which is having h1 tag";


//Que-3Write the code to access element which is having class as "box"

document.getElementsByClassName("box")[0].innerText =
  "Code for the box!!";


//Que-4"<h1>Hello </h1>  Change the heading from ""Hello""to ""Hello World"" using DOM functions"

document.getElementsByTagName("h1")[1].innerText = "Hello World";


//Que-5 Create three cards on HTML page and arrange them using flex property in row or
...
//Que-8 Create an HTML page having content as Hello world and a button named Replace Text.
...
//Que-10 Create a select drop down for selecting Year 20-21, 21-22 etc. Print the item text selected
